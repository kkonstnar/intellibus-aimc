...
export const MagicLinkEmail = ({
  ...
  // Create tracking URL for the magic link
  const trackedLink = `${trackingUrl}/track/click?redirect=${encodeURIComponent(
    magicLinkUrl
      ...
      <Body style={main}>
        ...
        <Container style={container}>
          ...
          <Section style={footer}>
            <Img
              src={`${baseUrl}/AIMC_Angled_Horiz_w Title_Violet.png`}
              width="120"
              height="auto"
              alt="AI Masterclass"
              style={logo}
